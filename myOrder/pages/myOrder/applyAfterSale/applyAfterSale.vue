...
<script>
  import ApplyAfterSaleForm from '@/myOrder/pages/myOrder/components/ApplyAfterSaleForm/ApplyAfterSaleForm.vue';
  import ApplyAfterSaleType from '@/myOrder/pages/myOrder/components/ApplyAfterSaleType/ApplyAfterSaleType.vue';
  import NavBar from '@/components/NavBar/NavBar.vue';
  import OrderProductItem from '@/myOrder/pages/myOrder/components/OrderProductItem/OrderProductItem.vue';
  import OrderProductNumberBox from '@/myOrder/pages/myOrder/components/OrderProductNumberBox/OrderProductNumberBox.vue';
