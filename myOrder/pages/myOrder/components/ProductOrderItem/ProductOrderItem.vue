...
<script>
  ...
  export default {
    ...
    methods: {
      gotoDetail() {
        uni.navigateTo({
          url: `/myOrder/pages/myOrder/productOrderDetail/productOrderDetail?id=${this.order.orderNumber}`,
        });
      },
      gotoShipping() {
        uni.navigateTo({ url: '/myOrder/pages/myOrder/shippingPackages/shippingPackages' });
      },
      gotoAddComment() {
        uni.navigateTo({ url: '/myOrder/pages/myOrder/productAddComment/productAddComment' });
      },
      gotoAfterSale() {
