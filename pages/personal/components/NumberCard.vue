...
<script>
  export default {
    components: {},
    props: {
      coinsNum: { type: String, default: `8000` },
      integralNum: { type: String, default: `500` },
      couponNum: { type: String, default: `215` },
    },
    data() {
      return {};
    },
    ...
    methods: {
      onClick() {
        uni.navigateTo({ url: '/pages/personal/bonusCoin/index/index' });
      },
      onClick_1() {
        uni.navigateTo({ url: '/pages/personal/bonusPoint/index/index' });
      },
      onClick_2() {
...
<style scoped lang="less">
  .wrap {
    ...
    background-image: linear-gradient(180deg, #494642 0%, #494642 -31.98%, #23221f 84.06%, #23221f 100%);
