<template>
  <view class="flex-col">
    <view class="flex-col items-center">
      <text class="title">邀请好友注册得收纳币奖励</text>
      <text class="desc desc-opactiy desc-text mt-16">每邀请一位好友下单，即可获得收纳币奖励</text>
    </view>
    <view class="flex-row justify-between step-wrap mt-28">
      <view class="flex-col items-center">
