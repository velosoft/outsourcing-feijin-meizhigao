  ...
  <view class="flex-col page">
    ...
    <view class="flex-col flex-1 container">
      ...
      <view class="flex-col line-tabs">
        ...
        ></multi-card-tabs>
        <activity-status-waiting v-if="activityStatus === 0" class="self-center" />
        <activity-status-running v-if="activityStatus === 1" />
        <activity-status-expired v-if="activityStatus === 2" class="self-center" />
        <card-tabs class="tabs-wraper" :value="value" :tabs="tabs" @change="onCardTabs"></card-tabs>
        <view class="flex-col">
          <list-container
        ...
        .btn-tips {
          ...
          .count-down-wrap {
            ...
            .count-down-con {
              ...
              .number-box {
                padding: 8rpx 0;
                background-image: linear-gradient(180deg, #b4352e 0%, #ce3933 100%);
                border-radius: 4rpx;
                width: 34rpx;
                height: 34rpx;
                .time-font {
