<template>
  <view class="flex-col container">
    <view class="flex-row justify-between">
      ...
      <image class="share-icon" src="/static/images/icon_share.png" @click="onShare" />
    </view>
    ...
    <view class="flex-row coupon-wraper items-center">
      ...
      <view class="flex-row button ml-19 items-center" @click="onShowCoupon">
        ...
        <image class="icon_arrow ml-3" src="/static/images/icon_right_arrow_02.png" />
      </view>
    </view>
...
<script>
  import PopCouponList from './PopCouponList.vue';
  export default {
    components: { PopCouponList },
    props: {
