    ...
    <view class="flex-col flex-1">
      <view class="scroll-height">
        ...
        <view class="flex-col flex-1 info">
          ...
          ></activity-card>
          <view class="flex-col relative container" :style="{ marginTop: pageData.activity ? '-28rpx' : '' }">
            <product-header
      ...
      <footer-bar :hasActivity="!!pageData.activity" :activityStarted="true"></footer-bar>
    </view>
      ...
      return {
        ...
        pageData: {
          product: {
            ...
            tags: ['新客优惠', '新品上市', '好评推荐'],
            buyer: 100,
            detail: ['https://picsum.photos/375/1000', 'https://picsum.photos/375/1000'],
          },
          activity: null,
          comments: [],
          swiperList: [
