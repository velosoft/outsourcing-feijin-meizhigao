<template>
  <view class="flex-col">
    <view class="flex-row items-baseline title-view">
      <text class="font title">空间收纳设计,</text>
      <text class="font sub-title ml-5">一对一服务</text>
    </view>
    <view class="flex-row menu-wrap panel-mt-22">
      <view class="flex-col justify-start relative menu-left">
        <image class="product-bg pos" :src="bgUrl" />
      ...
      <view class="flex-col menu-right ml-12">
        <navigator url="/pages/shopList/shopList?title=课程中心" hover-class="none">
        ...
        <navigator url="/pages/shopList/shopList?title=服务中心" hover-class="none">
...
<script>
  export default {
    ...
    data() {
      return {
        // bgUrl: 'https://picsum.photos/332/344',
        bgUrl: '/static/images/service_bg.png',
      };
    },
