<template>
  <view class="flex-col page">
    ...
    <view class="flex-col justify-start flex-1 main-content-group">
      <view class="flex-col order-details-group">
        <view class="flex-row items-center order-summary-section">
          <view class="flex-col shrink-0 relative image-wrapper">
            ...
            >
              <text class="content-font product-count-text"
                >{{ productNumber }}件商品</text
              >
            </view>
          </view>
        ...
        <view class="flex-col justify-start margin-top-standard view">
          <u-cell-group :border="false">
            ...
            <view class="flex-row items-center self-stretch">
              ...
              <text class="placeholder-font placeholder-text"
                >请填写企业抬头</text
              >
              <view
                class="flex-col justify-start items-center shrink-0 invoice-title-group"
              >
                <image
        ...
        <view
          class="flex-col justify-start invoice-section margin-top-standard"
        >
        ...
        <view class="flex-col invoice-section margin-top-standard">
          ...
          <text
            class="self-stretch content-font invoice-notice-content margin-top-standard"
          >
      ...
      <view
        class="fixed-bottom-safe flex-col justify-start fixed bottom-action-section"
      >
