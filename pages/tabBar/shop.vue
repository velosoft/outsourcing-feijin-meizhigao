  ...
  <view class="flex-row">
    <view class="flex-col">
      <view class="sider-bar">
        <view class="pics">
          ...
          >
            <view
              class="flex-row group_22"
              :class="{ active: isActive === index }"
              @click="checked(index)"
            >
              <view :class="{ section_3: isActive === index }"></view>
              <text class="ml-20 sider-bar-text" :class="{ active: isActive === index }">{{ item.tit }}</text>
            </view>
          </scroll-view>
        </view>
      </view>
    ...
    <view class="flex-col flex-1 group_5">
      <view class="flex-col justify-start swiper-wrap">
        ...
        <view class="flex-row justify-evenly image-wrapper pos_4">
      ...
      <view class="mt-16 flex-row tabs-wrap">
        <view class="flex-col justify-start items-center shrink-0 text-wrapper"
          ><text class="text_7">全部</text></view
        >
        <view
          class="ml-6 flex-col justify-start items-center shrink-0 text-wrapper_2"
        >
          <text class="font_4">塑料材质</text>
        </view>
        <view
          class="ml-6 flex-col justify-start items-center shrink-0 text-wrapper_3"
        >
          <text class="font_4">铁质收纳盒</text>
        </view>
        <view
          class="ml-6 flex-col justify-start items-start shrink-0 text-wrapper_4"
        >
          <text class="font_4 text_10">小物件收纳盒</text>
        </view>
      </view>
        ...
        >
          ...
          <view class="ml-12 flex-col shop-con">
            ...
            <view class="flex-row tag items-center">
              <view
                class="text-wrapper_10 items-center flex-row"
                v-for="(item, index) in items_1"
                :key="index"
              >
                <text class="font_5 text_14">新品上市</text>
              </view>
            </view>
            <view class="flex-row items-center shop-con-bottom">
              <text class="font_6 text_16">定金</text>
              <view class="flex-row shrink-0">
                <text class="self-start text_17">￥</text>
                <text class="font_7 text_18">200</text>
                <text class="self-center font_8 text_19">.00</text>
              </view>
              <text class="font_6 text_20">100人预约</text>
            </view>
          </view>
        </view>
      </view>
