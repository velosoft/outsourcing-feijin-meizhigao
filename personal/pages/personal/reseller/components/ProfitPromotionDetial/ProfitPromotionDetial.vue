  ...
  <view class="flex-col wrap">
    <view class="flex-row justify-between header items-center">
      ...
      <view class="select-wrap flex-row items-center" @click="onClick">
        ...
        <image class="shrink-0 icon-select ml-2" src="/personal/static/images/icon_select.png" />
      </view>
    </view>
...
<script>
  ...
  import ProfitListItem from '@/personal/pages/personal/reseller/components/ProfitListItem/ProfitListItem.vue';
