...
<script>
  ...
  import LevelDescription from '@/personal/pages/personal/member/components/LevelDescription/LevelDescription.vue';
  import MemberBenefitsItem from '@/personal/pages/personal/member/components/MemberBenefitsItem/MemberBenefitsItem.vue';
  import MemberCover from '@/personal/pages/personal/member/components/MemberCover/MemberCover.vue';
